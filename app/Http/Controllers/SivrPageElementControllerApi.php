...
class SivrPageElementControllerApi extends Controller
{
    ...
    public function store(Request $request)
    {
          ...
          return  $result = $this->sivrPageElementService->createItem($request);
     ...
     *
     */
    public function destroy( $sivrPageElement)
    {
        $pageElement=  SivrPageElement::find($sivrPageElement);
          return  $result = $this->sivrPageElementService->deleteItem($pageElement);
