                                            ...
                                            <div class="g-create-form">
                                                ...
                                                <h5 >Menu icon </h5>
                                                    ...
                                                    <div class="icon-preview">
                                                        <div class="icon-image-container {{ isset($uploadedIconUrl) ? '' : 'icon-label-empty' }}"
                                                ...
                                                <form class=" mb-3 w-100" id="audioForm" method="POST"
                                                      ...
                                                      multiple>
                                                    @csrf
                                                    <input type="hidden" name="page_element_id" value="{{$pageElement->id}}">
                                                    <label class="menu-icon-label" for="menu_icon">Upload Menu Icon</label>
                                                    <input class="form-control upload-icon-btn" type="file" accept="image/*"
                                                           name="menu_icon"
                                                           id="menu_icon" />
