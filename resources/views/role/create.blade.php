                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="g-create-form">
                                                ...
                                                <form action="{{ route('roles.store') }}" method="POST">
                                                                        ...
                                                                        <ul>
                                                                            ...
                                                                            <li>
                                                                                @foreach ($group->permissions as $permission)
                                                                                    <span class="border-0"><label><input class="{{$group->slug}}" name="permissions[{{$group->slug}}][]" type="checkbox" value="{{$permission->id}}"> {{$permission->name}}</label></span>
                                                                                @endforeach
                                                                            </li>
                                                                        </ul>
                                                                    </section>
                                                    ...
                                                    <input type="submit" class="form-control form-control-sm" value="Save">
                                                </form>
                                            </div>
                                        </div>
                                    </div>
