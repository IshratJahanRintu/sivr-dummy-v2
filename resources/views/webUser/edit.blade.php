                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="g-create-form">
                                                <!--Start Form-->
                                                <form action=" {{ route('users.update', $dataPack->user->id) }}" method="POST">
                                                    @csrf
                                                    {{ method_field('PUT') }}
                                                    <div class="row">
                                                        <div class="form-group col-md-4 mb-3">
                                                            ...
                                                            <input type="text" name="first_name" id="first_name"
                                                                class="form-control form-control-sm" value="{{old('first_name', $dataPack->user->first_name)}}">
                                                        ...
                                                        <div class="form-group col-md-4 mb-3">
                                                            ...
                                                            <input type="text" name="last_name" id="last_name"
                                                                class="form-control form-control-sm" value="{{old('last_name', $dataPack->user->last_name)}}">
                                                        ...
                                                        <div class="form-group col-md-4 mb-3">
                                                            ...
                                                            <input type="email" class="form-control form-control-sm"
                                                                id="email" name="email" value="{{old('email', $dataPack->user->email)}}">
                                                        </div>

                                                        <div class="form-group col-md-4 mb-3">
                                                            <label for="mobile">Mobile</label>
                                                            <input type="text" name="mobile" id="mobile"
                                                                class="form-control form-control-sm" value="{{old('mobile', $dataPack->user->mobile)}}">
                                                        </div>

                                                        <div class="form-group col-md-4 mb-3">
                                                            <label for="address">Address</label>
                                                            <input type="text" name="address" id="address"
                                                                class="form-control form-control-sm" value="{{old('address', $dataPack->user->address)}}">
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-4 mb-3">
                                                            ...
                                                            <select class="form-select form-select-sm" aria-label="Client ID"
                                                                ...
                                                                @foreach ($dataPack->roles as $item)
                                                                    <option value="{{ $item->id }}" {{old('role', $dataPack->user->roles->first()->id) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                                                @endforeach
                                                            </select>
                                                            @if ($errors->has('role'))
                                                        ...
                                                        <div class="form-group col-md-4 mb-3">
                                                            ...
                                                            <input type="text" name="username" id="username"
                                                                class="form-control form-control-sm" value="{{old('username', $dataPack->user->username)}}">
